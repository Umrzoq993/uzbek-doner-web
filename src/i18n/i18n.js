...
export const resources = {
  uz: {
    ...
    checkout: {
      cart: "Savat",
      cart_empty: "Savat bo‘sh",
      note_for_restaurant: "Buyurtma uchun izoh",
      ...
      floor: "Qavat",
      apt: "Kv/Ofis",
      courier_note: "Buyurtma uchun izoh",
      ...
      toast_closed: "Hozir buyurtma qabul qilinmaydi. Ish vaqti 09:00 - 03:00.",
      payment: "To‘lov",
  ...
  ru: {
    ...
    checkout: {
      ...
      toast_closed:
        "Заказы временно не принимаются. Время работы 09:00 - 03:00.",
      payment: "Оплата",
